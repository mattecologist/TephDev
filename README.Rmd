...
## basic example code
```
using a location, create a temperature vector from Australian weather stations (this function is used to create hourly data, so its then straightforward to get Ta)
```{r}
